...
<head>
    ...
    <title><?php echo Registry::load('strings')->not_found_page_title.' - '.Registry::load('settings')->site_name; ?></title>
    <meta name="description" content="<?php echo Registry::load('strings')->not_found_page_description; ?>">
