...
<head>
    ...
    <title><?php echo Registry::load('strings')->offline_page_title.' - '.Registry::load('settings')->site_name; ?></title>
    <meta name="description" content="<?php echo Registry::load('strings')->offline_page_description; ?>">
    ...
    <link href="<?php echo Registry::load('config')->site_url ?>assets/fonts/montserrat/font.css" rel="stylesheet">
